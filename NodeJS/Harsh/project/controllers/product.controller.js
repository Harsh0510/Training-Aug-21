...
router.get("/", verifytoken, authPage(["1"]), ProductController.getAllProducts);
router.get("/:id", verifytoken, authPage(["1"]), ProductController.getProduct);
router.put("/:id", verifytoken, authPage(["1"]), ProductController.updateProduct);
router.delete("/:id", verifytoken, authPage(["1"]), ProductController.deleteProduct);
